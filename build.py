...
</div><div class="copy">© {YEAR} {esc(B['name'])}{"  t.a.v. Triple A Trading" if lang == "nl" else ("  à l'att. de Triple A Trading" if lang == "fr" else "")}{" — " + esc(B['vat']) if B['vat'] else ""} — {esc(u['ft_rights'])}</div></footer>"""
